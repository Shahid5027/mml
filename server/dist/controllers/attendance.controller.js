...
exports.getHistory = exports.getTodayStatus = exports.checkOut = exports.checkIn = void 0;
...
function checkIsLate(shiftStartTime, lateThresholdMinutes) {
    const now = new Date();
...
const checkIn = async (req, res) => {
    ...
    try {
        ...
        let office = await prisma_1.prisma.officeSettings.findFirst();
        if (!office) {
            // Seeding fallback
            office = await prisma_1.prisma.officeSettings.create({
...
const checkOut = async (req, res) => {
    ...
    try {
        ...
        const activeAttendance = await prisma_1.prisma.attendance.findFirst({
            where: {
                userId,
                date: todayDate
            }
...
const getTodayStatus = async (req, res) => {
    ...
    try {
        ...
        const office = await prisma_1.prisma.officeSettings.findFirst();
        return res.status(200).json({
            attendance,
...
const getHistory = async (req, res) => {
    ...
    try {
        ...
        const history = await prisma_1.prisma.attendance.findMany({
            where: {
                userId,
                date: {
                    gte: startDate,
